...
public class LMSPackageHandler {
	...
	/****************************************************************************
	 **
	 ** Method: Constructor Input: none Output: none
	 **
	...
	/****************************************************************************
	 **
	 ** Method: version() Input: none Output: String -- Representing the Version
	 * of the class
	 **
	 ** Description: This method is being used as a debugging tool. It returns a
	 * string indicating the version number of the class file.
	 **
	 *****************************************************************************/
	...
	/****************************************************************************
	 **
	 ** Method: display() Input: String zipFileName -- The name of the zip file
	 * to be used Output: none
	 **
	 ** Description: This method is being used as a debugging tool. It writes the
	 * contents of a zip file to the dos console.
	 **
	 *****************************************************************************/
	...
	/****************************************************************************
	 **
	 ** Method: extract() Input: String zipFileName -- The name of the zip file
	 * to be used Sting extractedFile -- The name of the file to be extracted
	 ** from the zip Output: none
	 **
	 ** Description: This method takes in the name of a zip file and a file to be
	 * extracted from the zip format. The method locates the file and extracts
	 * into the '.' directory.
	 ** 
	 *****************************************************************************/
	...
	/****************************************************************************
	 **
	 ** Method: findManifest() Input: String zipFileName -- The name of the zip
	 * file to be used Output: Boolean -- Signifies whether or not the manifest
	 * was found.
	 **
	...
	/****************************************************************************
	 **
	 ** Method: findMetadata() Input: String zipFileName -- The name of the zip
	 * file to be used Output: Boolean -- Whether or not any xml files were
	 * found
	 **
	 ** Description: This method takes in the name of a zip file and locates all
	 * files with an .xml extension
	 ** 
	 *****************************************************************************/
	...
	/****************************************************************************
	 **
	 ** Method: locateMetadata() Input: String zipFileName -- The name of the zip
	 * file to be used Output: Vector -- A vector of the names of xml files.
	 **
	 ** Description: This method takes in the name of a zip file and locates all
	 * files with an .xml extension an adds their names to a vector.
	 ** 
	 *****************************************************************************/
	...
	/****************************************************************************
	 **
	 ** Method: getListOfMetadata() Input: String zipFileName -- The name of the
	 * zip file to be used Output: String -- A comma delimited list of meta-data
	 * files.
	 **
	 ** Description: This method takes in the name of a zip file and locates all
	 * files with an .xml extension an adds their names to a vector. The vector
	 * is then changed to a comma delimited string and returned to the caller.
	 ** 
	 *****************************************************************************/
